...
//**********1 order NS*****
void temp_uv_ini(double **c1,double **c2, double **tu, double **tv, double **u, double **v, double **adv_u, double **adv_v, double **worku, double **workv, double **fx, double **fy);
...
void cahnpsi_ini(double **c_old, double **adv_c,double **c_new);
void sourcepsi_ini(double **c_old, double **adv_c, double **src_c, double **src_mu);
void cahnphi_ini(double **c_old, double **adv_c,double **c_new);
void sourcephi_ini(double **c_old, double **adv_c,  double **src_c, double **src_mu);

void vcycle_ini(double **uf_new, double **wf_new, double **su, double **sw,double M,double S, double gam2, int nxf, int nyf, int ilevel);

void relax_ini(double **c_new, double **mu_new, double **su, double **sw, double M, double S, double gam2,int ilevel, int nxt, int nyt);

void defect_ini(double **duc, double **dwc, double **uf_new, double **wf_new,double **suf, double **swf,double M,double S, double gam2, int nxf, int nyf);

void nonL_ini(double **ru, double **rw, double **c_new, double **mu_new,double M, double S, double gam2, int nxt, int nyt);
